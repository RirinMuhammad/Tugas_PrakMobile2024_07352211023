        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) =>  Satu()), // Navigasi ke halaman Bab4
              );
            },
          ),
          const SizedBox(width: 16),
  ...
  Widget build(BuildContext context) {
    return Column(
        children: [
          BestBookingCard(
            imageUrl: 'assets/images/kue2.png',
            profileUrl: 'assets/images/kue2.png',
            name: 'Miss Zachary Will',
            role: 'Beautician',
          ...
          Stack(
            children: [
              ClipRRect(
                ...
                child: Image.asset(
                  'assets/images/kue2.png', // Ganti dengan path gambar Anda
                  height: 230,
                  width: double.infinity,
                  fit: BoxFit.cover,
                ),
...
class _SatuState extends State<Satu> {
  ...
  // Fungsi untuk memperbarui jumlah item atau menghapus item
  void updateItemQuantity(int index, {int? quantity, bool? delete}) {
    setState(() {
      if (delete == true) {
        cartItems.removeAt(index); // Hapus item dari daftar
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text("Item berhasil dihapus")),
        );
      } else if (quantity != null) {
        cartItems[index].jumlah = quantity; // Perbarui jumlah item
      }
    });
  }
          ...
          leading: Padding(
            ...
            child: Container(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  Navigator.pushNamed(context, '/ECommerceApp');
                },
              ),
            ),
          ),
              ...
              children: cartItems.asMap().entries.map((entry) {
                ...
                return ListItem(
                  ...
                  onQuantityChanged: (quantity) {
                    updateItemQuantity(index, quantity: quantity);
                  },
                  onDelete: () {
                    updateItemQuantity(index, delete: true); // Menghapus item
                  },
                );
              }).toList(),
            ),
...
class ListItem extends StatelessWidget {
  ...
  ListItem({required this.item, required this.onQuantityChanged, required this.onDelete});
            ...
            Column(
              ...
              children: [
                IconButton(
                  ...
                  onPressed: onDelete, // Menghapus item
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
