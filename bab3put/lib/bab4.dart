...
class ListItem extends StatelessWidget {
  ...
  const ListItem({super.key, required this.item, required this.onQuantityChanged});
  ...
  children: [
    Padding(
      padding: const EdgeInsets.only(left: 80.0), // Geser ikon delete ke kanan
      child: IconButton(
    ...
    Row(
      ...
      children: [
        Container(
          decoration: BoxDecoration(
            shape: BoxShape.circle,
            color: const Color.fromARGB(255, 116, 3, 254).withOpacity(0.3),
          ),
          child: IconButton(
